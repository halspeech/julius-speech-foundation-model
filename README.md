...
# **Centurion** is a lightweight plug-in that lets the classic **[Julius](https://github.com/julius-speech/julius)** decoder work with state-of-the-art speech foundation models—**wav2vec 2.0, WavLM, HuBERT, Whisper**, and more.  Keep Julius’ blazing‑fast feature front-end and decoding backend, and add the acoustic power of giant foundation model encoders. No source code change in the Julius side.
